...
# fetch the last 5 games that the Charlotte Hornets played

team_game_logs = TeamGameLogs(team_id_nullable='1610612766', last_n_games_nullable=5)
team_game_logs.get_request()
team_game_logs.data_sets[0].dataframe
team_game_logs.data_sets[0].dataframe.to_csv('charlotte_hornets_last_5_games.csv')
